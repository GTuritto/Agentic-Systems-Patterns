...
Usa este pattern para state local de task. La durable memory se maneja con [Memory-Augmented Agent](/memory-knowledge/memory-augmented-agent). El ensamblaje de context se maneja con [Context Engineering](/foundations/context-engineering).
...
- [Descargar paquete fuente](/downloads/goals-and-state.zip)
