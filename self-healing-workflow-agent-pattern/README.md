...
Self-healing workflows detect failed steps and recover through retry, fallback, re-planning, compensation, or escalation. The pattern is useful when failure is expected, classified, and bounded by policy.
